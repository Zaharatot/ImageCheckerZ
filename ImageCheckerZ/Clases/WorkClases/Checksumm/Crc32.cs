...
namespace ImageCheckerZ.Clases.WorkClases.Checksumm
{
    ...
    internal class Crc32
    {
        ...
        public byte[] ComputeChecksum(byte[] bytes)
        {
            ...
            //Возвращаем результат, инвертировав и реверсировав порядок байт
        ...
        /// <returns>Значение чексуммы</returns>
        public byte[] ComputeChecksum(string data)
        {
            byte id;
            //Инициализируем значение заполненное единицами
            uint crc = 0xffffffff;
